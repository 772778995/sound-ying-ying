...
export class AxiosHeaders {
	constructor(headers?: RawAxiosHeaders | AxiosHeaders, defaultHeaders?: RawAxiosHeaders | AxiosHeaders)
...
export interface AxiosRequestConfig<
	...
	C = 'application/json' | 'multipart/form-data' | 'application/x-www-form-urlencoded' | 'none'
> {
	url?: U
...
export interface AxiosInstance extends Axios {
	...
	<T = any, R = AxiosResponse<T>, D = any>(url: Urls['all'], config?: Omit<AxiosRequestConfig<D>, 'url'>): Promise<R>
